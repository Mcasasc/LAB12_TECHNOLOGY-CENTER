...
public class FrmAlumnosView extends javax.swing.JFrame {

    private DefaultTableModel modelo_tabla_alumnos;
    private String[] cabeceras = {"ID", "NOMBRE", "DIRECCION", "TELEFONO", "EMAIL"};
    private String[][] informacion = {};

    public FrmAlumnosView() {
        initComponents();

        modelo_tabla_alumnos = new DefaultTableModel(informacion, cabeceras);
        tblAlumnos.setModel(modelo_tabla_alumnos);
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAlumnosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAlumnosView().setVisible(true);
            }
        });
    }
